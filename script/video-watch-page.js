...
const NICONICO_CLASSIC_VIDEO_ID_GETTING_MUTATION_OBSERVER = new MutationObserver(() => {
...
NICONICO_CLASSIC_VIDEO_ID_GETTING_MUTATION_OBSERVER.observe(document.querySelector("meta\[property=\"og:url\"\]"), { attributes: true });
